    ...
    <div className="build-lab-page">
      ...
      <div className="build-tools-row">
        ...
        <section className="code-coach-panel">
          ...
          <p>Type a question about your project, then open it in the full AI Coach chat for help.</p>
          ...
          <div className="code-coach-actions">
            <button className="camp-primary" onClick={askCoach} disabled={!coachQuestion.trim()}>Ask AI Coach</button>
          </div>
        </section>
      </div>
    </div>
